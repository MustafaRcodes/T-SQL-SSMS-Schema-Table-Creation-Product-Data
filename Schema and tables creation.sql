...
DROP SCHEMA ordersschema;

CREATE TABLE [ordersschema]. [orders_data](
...
ALTER TABLE [ordersschema]. [orders_data]
ADD [product_price] [float] NULL;

ALTER TABLE [ordersschema]. [orders_data]
DROP COLUMN [product_price];

DROP TABLE [ordersschema].[orders_data];

insert into [ordersschema].[orders_data] values
...
select * from [ordersschema].[orders_data];

create table [ordersschema]. [returns_data]
(
order_id [nvarchar](20),
return_reason varchar(20)
);

insert into [ordersschema]. [returns_data] values
...
select * from [ordersschema]. [returns_data];
